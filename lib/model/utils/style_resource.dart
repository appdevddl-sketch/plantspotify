...
class StyleResource {
  ...
  TextStyle styleSemiBoldItalic(double fontSize, Color color) {
    return TextStyle(
        fontSize: fontSize,
        color: color,
  ...
  TextStyle styleMediumItalic(double fontSize, Color color) {
    return TextStyle(
        fontSize: fontSize,
        color: color,
        fontStyle: FontStyle.italic,
  ...
  TextStyle styleRegularItalic(double fontSize, Color color) {
    return TextStyle(
        fontSize: fontSize,
        color: color,
        fontStyle: FontStyle.italic,
