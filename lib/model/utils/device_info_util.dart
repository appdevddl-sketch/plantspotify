...
class DeviceInfoUtil {
  ...
  static DeviceInfoUtil get instance {
    _instance ??= DeviceInfoUtil._init();
    return _instance!;
  }
  DeviceInfoUtil._init();
    ...
    try {
      if (kIsWeb) {
        ...
        if (Platform.isAndroid) {
          ...
          deviceData = _readWindowsDeviceInfo(await _deviceInfoPlugin.windowsInfo);
        }
      }
    } on PlatformException {
